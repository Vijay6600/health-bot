                            ...
                            child: Row(
                              children: [
                                Link(
                                  ...
                                  uri: Uri.parse(
                                      'https://www.facebook.com/profile.php?id=100010762545746'),
                                ...
                                Link(
                                  target: LinkTarget.blank,
                                  uri: Uri.parse(
                                      'https://www.linkedin.com/in/ajay-gupta-0045661b5/'),
                                  builder: (context, followLink) {
                                    return ElevatedButton(
                                      onPressed: followLink,
                                      style: ButtonStyle(
                                ...
                                Link(
                                  target: LinkTarget.blank,
                                  uri:
                                      Uri.parse('https://github.com/Ajay21g?tab=repositories'),
                                  builder: (context, followLink) {
                                    return ElevatedButton(
                                      onPressed: followLink,
                                      style: ButtonStyle(
                                ...
                                Link(
                                  target: LinkTarget.blank,
                                  uri: Uri.parse('http://wa.me/+919930800859'),
                                  builder: (context, followLink) {
                                    return ElevatedButton(
                                      onPressed: followLink,
                                      style: ButtonStyle(
                                ...
                                Link(
                                  target: LinkTarget.blank,
                                  uri: Uri.parse(
                                      'https://www.instagram.com/_ajay.gupta_21/'),
                                  builder: (context, followLink) {
                                    return ElevatedButton(
                                      onPressed: followLink,
                                      style: ButtonStyle(
